...
Tl;dr: Want your child to (have a chance to statistically) perform well in school? Make sure both you and your spouse are educated (the more the better). Ensure that your child drinks alcohol as infrequently as possible (especially on workdays). Situate yourself in an urban setting (i.e. close to school if that's the case), and provide your child with access to internet.
